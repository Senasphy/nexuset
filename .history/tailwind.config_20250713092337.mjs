...
export default {
  ...
  theme: {
  	extend: {
        ...
        // This tells Tailwind to use the CSS variable and wrap it in hsl()
        // The /<alpha-value> is crucial for allowing opacity utilities like bg-primary/50
        ...
        // If you want to use the chart colors directly with Tailwind utilities:
